...
// import { products as productData } from "../assets/Data.jsx";
...
//   const searchQuery = params.get("search") || ""; // get search from URL
...
//         });
//         dispatch(setProducts(res.data)); // save in redux
...
//         const cartItem = {
//     ...product,
//     _id: product._id,               // keep unique id
//     image: product.image?.url || product.image, // flatten image
//     quantity: 1
//   };  
...
//     .filter((p) => p.category.toLowerCase().includes(searchTerm.toLowerCase()));
...
//                 // className=" object-contain rounded-md mb-3 bg-white"

//               />
//               <h3 className="text-lg font-semibold">{p.name}</h3>
//               <p className="text-gray-600 capitalize">{p.category}</p>
//               <p className="font-bold  flex items-center text-red-600"><MdOutlineCurrencyRupee></MdOutlineCurrencyRupee>{p.price}</p>
